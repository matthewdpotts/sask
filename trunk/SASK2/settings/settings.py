...
DATABASE_NAME = 'frim1'             # Or path to database file if using sqlite3.
DATABASE_USER = 'frim_user1'             # Not used with sqlite3.
DATABASE_PASSWORD = 'joshua'         # Not used with sqlite3.
