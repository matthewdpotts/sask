...
#from trees.models import Tree, TreeSurvey
...
urlpatterns = patterns(
	...
	(r'^SASK_media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': '/home/brice/django/projects/SASK2/SASK_media'}),
	#(r'^SASK_media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': '/var/django_root/django_projects/SASK2/SASK_media'}),
